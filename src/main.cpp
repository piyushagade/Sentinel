...
uint8_t INTERVAL_BASE[4] = {15, 15, 15, 216};
uint8_t INTERVAL_MULTIPLIER[4] = {8, 8, 8, 200};
...
uint32_t start_timestamp[] = {millis() / 1000, millis() / 1000, millis() / 1000, millis() / 1000};
...
void shield(uint8_t, callback_t_func);
...
/*
    WDT shield
*/
void shield(uint8_t duration, callback_t_func function) {
